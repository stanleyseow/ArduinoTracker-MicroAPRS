...
const float HOME_LAT = 3.16925;
const float HOME_LON = 101.64972;
const float RKK_LAT = 3.17133;
const float RKK_LON = 101.6135;
const float RDG_LAT = 3.4175;
const float RDG_LON = 101.765;
const float RTB_LAT = 2.843;
const float RTB_LON = 102.0575;
